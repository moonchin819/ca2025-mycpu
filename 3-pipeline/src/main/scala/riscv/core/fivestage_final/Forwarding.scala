...
class Forwarding extends Module {
  ...
  when(io.reg_write_enable_mem && io.rd_mem === io.rs1_ex && io.rs1_ex =/= 0.U) {
  ...
  }.elsewhen(io.reg_write_enable_wb && io.rd_wb === io.rs1_ex && io.rs1_ex =/= 0.U) {
  ...
  when(io.reg_write_enable_mem && io.rd_mem === io.rs2_ex && io.rs2_ex =/= 0.U) {
  ...
  }.elsewhen(io.reg_write_enable_wb && io.rd_wb === io.rs2_ex && io.rs2_ex =/= 0.U) {
